...
public class NguoiDungDTO {
    ...
    public static NguoiDungDTO fromEntity(NguoiDung ng) {
        return new NguoiDungDTO(ng.getId(), ng.getMaNguoiDung(), ng.getEmail(), ng.getMatKhau(), ng.getTen(), ng.getHo(), ng.getAnhDaiDien(), ng.getSoDienThoai(), ng.getGioiTinh(), ng.getDiem(), ng.getTrangThai(), ng.getNgayTao(), ng.getNgayCapNhat(), ng.getRankKhachHang(), null, null, null, null, null, null, null, null);
    }
