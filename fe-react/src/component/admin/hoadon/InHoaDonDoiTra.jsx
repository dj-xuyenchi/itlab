                ...
                <div id="content-to-export" style={{
                    ...
                    <div>
                        ...
                        <table style={{ borderCollapse: "collapse", width: "100%" }}>
                            ...
                            <tbody>
                                {data.truocDo && data.truocDo.map((item, index) => {
                                    return <tr>
                                        <td style={{
                                            border: "1px solid black"
                                        }}>
                    ...
                    <div>
                        <h4 style={{
                            marginBottom: "12px"
                        }}>Thông tin sản phẩm sau đổi trả</h4>
                        <table style={{ borderCollapse: "collapse", width: "100%" }}>
                            <thead>
                                <th style={{
                                    border: "1px solid black"
                            ...
                            <tbody>
                                {data.sauKhiDoi && data.sauKhiDoi.map((item, index) => {
                                    return <tr>
                                        <td style={{
                                            border: "1px solid black"
                                        }}>
