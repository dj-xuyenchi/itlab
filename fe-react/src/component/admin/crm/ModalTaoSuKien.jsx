...
function ModalTaoSuKien({ profit }) {
    ...
    return (
        <>
            ...
            <span onClick={() => {
                setIsShow(true)
            }} className="sussgest"> tạo sự kiện giảm giá</span>
            <Modal title="Tạo sự kiện giảm giá" open={isShow} onOk={() => {
                handleTaoSuKien()
                setIsShow(false)
            }} onCancel={() => {
                setIsShow(false)
                ...
                {isFetching && <>
                    <Row style={{
                        ...
                        <span style={{
                            color: 'red'
                        }} >Trên đây là gợi ý của tôi về sự kiện giảm giá bạn có thể chỉnh sửa lại tùy theo nhu cầu và cung ứng của cửa hàng hiện tại. <span style={{
                            color: "black"
                        }}>Tạo sự kiện giảm giá theo từng tháng</span></span>
                    </Row>
                    <Row style={{
                        marginTop: "12px"
                    }} >
